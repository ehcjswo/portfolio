// button 이동
gsap.set(".nextBtn", {autoAlpha:1})
gsap.set(".prevBtn", {autoAlpha:0})
document.querySelector(".nextBtn").addEventListener("click",()=>{
    gsap.to("#page", {x:"-50%"})
    gsap.to(".nextBtn",0.5, {autoAlpha:0})
    gsap.to(".prevBtn", {autoAlpha:1, delay:0.5})
})
document.querySelector(".prevBtn").addEventListener("click",()=>{
    gsap.to("#page", {x:"0%"})
    gsap.to(".prevBtn",0.5, {autoAlpha:0})
    gsap.to(".nextBtn", {autoAlpha:1, delay:0.5})
})
